...
Dieses Kapitel wird erst mit Kapitel link:#p5[p5.js – Einführung] relevant. Du kannst dieses Kapitel fürs Erste überspringen und später darauf zurück kommen.
...
1. Tutorial Source Code herunterladen von Download-URL: TODO. Die heruntergeladene ZIP-Datei entpacken.
1. Entpackten Ordner in Visual Studio Code öffnen
1. Die Datei index.html öffnen und in der Statuszeile auf "Go Live" klicken. Die index.html wird nun automatisch im Browser geöffnet.
1. Zurück im Visual Studio Code. Die Datei sketch.js öffnen. Darin die Funktion `draw` um die Anweisung `line(0, 0, 100, 100)` ergänzen. Änderungen speichern.
1. Die Seite im Browser wird automatisch neu geladen. Die Linie ist nun auf der Zeichenfläche sichtbar.
