...
Dieses Kapitel wird erst mit Kapitel xy relevant. Du kannst dieses Kapitel fürs Erste überspringen und später darauf zurück kommen.


Im Kapitel xy beginnst du Programme zu schreiben die einige dutzend Zeilen lang sind. Theoretisch kannst du diese direkt auf dieser Webseite mit dem p5.js inline Editor lösen. Komfortabler, und näher an der beruflichen Realität ist jedoch, wenn du dafür eine IDE verwendest. 

Führe folgende Schritte aus um Visual Studio Code optimal einzurichten für das Lösen der p5.js Übungen:

1. Visual Studio Code herunterladen und installieren: https://code.visualstudio.com/download
1. Plugin "p5.vscode" installieren: https://marketplace.visualstudio.com/items?itemName=samplavigne.p5-vscode
1. Tutorial Source Code herunterladen von Download-URL: xy . Die heruntergeladene ZIP-Datei entpacken.
1. Entpackten Ordner "tutorial" in Visual Studio Code öffnen
1. Die Datei p5-sketches/index.html öffnen und in der Statuszeile auf "Go Live" klicken. Die index.html wird nun automatisch im Browser geöffnet.
1. Zurück im Visual Studio Code. Die Datei p5-sketches/sketch.js öffnen. Darin die Funktion `draw` um die Anweisung `line(0, 0, 100, 100)` ergänzen.
1. Im Browser die Seite neu laden. Die Linie ist nun auf der Zeichenfläche sichtbar.
